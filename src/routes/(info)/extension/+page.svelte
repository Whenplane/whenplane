...
<div class="limit-large mx-auto mt-12 px-4">
  ...
  <div class="text-center">
    ...
    <br>
    or download zip for
    <a href="https://downloads.whenplane.com/whenplane_widget-firefox-2.1.8.zip" download>firefox</a> /
    <a href="https://downloads.whenplane.com/whenplane_widget-chrome-2.1.8.zip" download>chrome</a>
    <br>
    <br>
    <a
