...
export const load = (async ({fetch}) => {
  ...
  const {download, process} = dev ? await import("../../../scripts/time-extractor/time-extractor.ts") : {download: undefined, process: undefined};
  ...
  const {fileExists} = dev ? await import("../../../scripts/old-history-generator/utils.ts") : {fileExists: undefined};
