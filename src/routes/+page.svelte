	...
	<div class="space-y-3 inner" bind:this={mainContainer}>
		...
		<div class="text-center">
			...
			{#if data.specialStream && !page.data.isBot}
				...
				<br>
			{/if}
			<div class="card p-4 whitespace-nowrap shadow-x1 z-10 font-normal absolute" data-popup="estimated-special-stream-start" style="margin-top: 0; opacity: 0; pointer-events: none;">
		...
		<div class="text-center lateness-stats">
			...
			{#if !isFrame}
				...
				<div class="card w-58 shadow-2xl! overflow-hidden z-20 !bg-surface-500 absolute" data-popup="moreDropdown" style="opacity: 0; pointer-events: none; display: none;">
					<MoreLinks/>
